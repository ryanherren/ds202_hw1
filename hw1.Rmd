...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello everyone, my name is **Ryan Herren** and I am studying *software engineering*. I am a sophomore from West Des Moines, Iowa. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: One job that is related to Data Science is the [Automation Frameworks Engineer](https://www.tesla.com/careers/search/job/autopilot-automationframeworksengineer-58362) on the Autopilot team at Tesla. ![](/Users/ryanherren/Desktop/tesla.png)  
    
    This job has a lot to do with analyzing data received from their autopilots systems and refining it in order to produce algorithms that more efficiently detect and avoid potential obstacles encountered on the road. This job is technically a software engineering job, but there are a ton of data science pieces that are involved in it.
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am really interested in statistical analysis of all types. Specifically, I enjoy analyzing stock market trends.
